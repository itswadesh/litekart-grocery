<template>
  <div
    class="w-24 px-2 mr-2 bg-white rounded-lg shadow-md cursor-pointer mb-1 hover:bg-green-100 focus:outline-none focus:shadow-outline-green"
    :class="{
  ...
  >
    <div class="flex justify-between items-center">
      <h1 class="text-sm text-gray-700 my-2">{{ this.name }}</h1>
