<template>
  <div class="flex flex-col bg-white shadow-lg sm:shadow frosted">
    <div
      v-if="!settings.websiteName"
      class="px-4 py-2 font-thin tracking-wide text-center bg-gray-800 text-accent-900"
    >
      We experiencing an incident and we are on it.
    </div>
    <header class="z-50 w-full h-24 p-2 shadow-md lg:p-3 lg:h-16">
        ...
        <div class="relative flex items-center my-auto lg:mt-1">
          <div class="flex flex-row items-center mx-3 my-auto flex-nowrap">
            <div class="my-auto">
              ...
              <div
                v-if="!user"
                class="hidden my-auto tracking-wider cursor-pointer lg:flex sm:mb-0 text-primary-500 text-normal"
              ...
              <nuxt-link
                to="/login"
                v-if="!user"
                class="my-auto tracking-wider cursor-pointer lg:hidden sm:mb-0 text-primary-500 text-normal"
              >
                <!-- login icon  -->
                <svg
                  xmlns="http://www.w3.org/2000/svg"
          ...
          <nuxt-link :to="localePath('/my/wishlist')">
            <div class="">
              <!-- heart icon  -->
              <svg
                class="w-6 h-6 mx-2 my-auto transition duration-500 ease-in-out transform text-primary-500 hw hover:-translate-y-1 hover:scale-110 hover:text-accent-900"
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 20 20"
                fill="currentColor"
              >
          ...
          <nuxt-link :to="localePath('cart')" class="h-full mx-3 my-auto">
            <div class="relative flex flex-col">
              ...
              <div
                ...
                class="absolute top-0 right-0 flex items-center justify-center w-5 h-5 -mt-1 text-xs text-center text-white rounded-full -me-2 ms-1 bg-secondary-500"
              >
                {{ cart.qty }}
              </div>
            </div>
